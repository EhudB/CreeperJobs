...
import com.ehudblum.creeperjobs.data.ConfigSource;
import com.ehudblum.creeperjobs.data.DataSource;
...
public class CJData
{
	...
	private ArrayList<CJPlayer>	players					=
															new ArrayList<CJPlayer>();
	private ArrayList<CJParty>	parties					=
															new ArrayList<CJParty>();
	private ArrayList<CJJob>	jobs					=
															new ArrayList<CJJob>();
	private ArrayList<String>	forbiddenPrefixes		=
	...
	public void load()
	{
		String dataFolderPath =
								CreeperJobs.getInstance().getDataFolder().getAbsolutePath();
		source =
					new ConfigSource(dataFolderPath + "/players",

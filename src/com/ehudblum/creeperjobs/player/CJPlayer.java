...
public class CJPlayer extends CJSerializable {
    ...
    public CJPlayer(CJPlayerConfigHandler dataHandler, String playerUUID) {
        this(dataHandler, playerUUID, null);
    }

    public CJPlayer(CJPlayerConfigHandler dataHandler, String playerUUID, CJPlayerJob playerJob) {
        this(dataHandler, playerUUID, playerJob, null);
    }

    public CJPlayer(CJPlayerConfigHandler dataHandler, String playerUUID, CJPlayerJob playerJob, CJParty playerParty) {
        this(dataHandler, playerUUID, playerJob, playerParty, true);
    }

    public CJPlayer(CJPlayerConfigHandler dataHandler, String playerUUID, CJPlayerJob playerJob, CJParty playerParty, boolean jobSpam) {
